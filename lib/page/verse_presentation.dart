...
class _VersePresentationState extends State<VersePresentation> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: ThemeData(
          brightness: _whiteBackground ? Brightness.light : Brightness.dark,
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          Row(children: [
            ...
            IconButton(
                tooltip: 'Invert black and white',
                onPressed: () =>
                    setState(() => _whiteBackground = !_whiteBackground),
                icon: Icon(Icons.contrast, color: foreground)),
          ]),
          if (_sections.isEmpty)
            const Expanded(child: Center(child: Text('No lyrics available')))
          else ...[
            Padding(
                ...
                child: Text(
                  ...
                  semanticsLabel:
                      '${_sections[_index].label}, slide ${_index + 1} of ${_sections.length}',
                )),
            Expanded(
              ...
              itemBuilder: (context, index) =>
                ...
                final painter = TextPainter(
                    textDirection: TextDirection.ltr, textScaler: scaler);
                while (size > 22) {
                  painter.text = TextSpan(
                      text: _sections[index].text,
                ...
                return SingleChildScrollView(
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Center(
                        child: SizedBox(
                            width: width,
                            child: Text(_sections[index].text,
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    color: foreground,
                                    fontSize: size,
            ...
            Padding(
                ...
                child: Row(children: [
                  IconButton(
                      tooltip: 'Previous verse or chorus',
                      onPressed: _index == 0
                          ? null
                          : () => _pages.previousPage(
                              duration: const Duration(milliseconds: 280),
                      ...
                      icon: Icon(Icons.chevron_left,
                          color: _index == 0 ? Colors.grey : foreground)),
                  Expanded(
                      child: Text(
                          _index == _sections.length - 1
                              ? 'End of song'
                              : 'Swipe for next verse or chorus',
                          textAlign: TextAlign.center,
                          style: TextStyle(color: foreground, fontSize: 13))),
                  TextButton(
                      onPressed: _next,
                      child: Text(
                          _index == _sections.length - 1 ? 'Finish' : 'Next',
